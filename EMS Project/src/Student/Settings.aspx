<%@ Page Title="" Language="C#" MasterPageFile="~/src/Student/Dashboard.master" AutoEventWireup="true" CodeFile="Settings.aspx.cs" Inherits="src_Student_Settings" %>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <asp:TextBox  runat="server" ID="txtCurrentPassword" TextMode="Password" CssClass="form-control" OnTextChanged="CurrentPass_checck"></asp:TextBox>
                </div>
                <div class="col-md-4">
