<%@ Page Title="" Language="C#" MasterPageFile="~/src/Dashboard/Dashboard.master" AutoEventWireup="true" CodeFile="Profile.aspx.cs" Inherits="src_Dashboard_Profile" %>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox runat="server" ID="txtPhone" TextMode="Phone" CssClass="form-control" Enabled="false"></asp:TextBox>
